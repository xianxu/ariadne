...
def print_semantic_warmup():
    ...
    msg.append(f"             Run `sdlc active-time` over the issue's commit window")
    ...
    msg.append(f"             Pass FORCE=1 only if you genuinely cannot run it")
