...
- [Branching and Refreshing Slots](workflow/workspace-branching.md) — ordinary Git procedures for captured-source issue branches and explicit resting-branch fast-forwards (#245).
